...
https://raw.githubusercontent.com/fedebotu/vision-cartpole-dqn/save_model/cartpole_vision_v1.py

The git repo:
https://github.com/fedebotu/vision-cartpole-dqn


Credit: Federico Berto
...
def plot_durations(score):
    ...
    plt.savefig(save_graph_folder + graph_name)
    if is_ipython:
...
for i_episode in range(N_EPISODES):
    ...
    for t in count():
        ...
        state_variables, _, done1, done2, _ = env.step(action.item())
        done = done1 or done2
